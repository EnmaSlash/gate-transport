import { DeliveryFlow } from "@/app/c/_flows/DeliveryFlow";
import { resolveCarrierTokenToJobId } from "@/app/c/_server/resolveToken";

export const runtime = "nodejs";

export default async function CarrierDeliveryPage(
  ...
  return <DeliveryFlow jobId={resolved.jobId} token={token} />;
}
